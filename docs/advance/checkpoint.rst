...
.. code:: bash
    ...
    usage: model_merger_v2.py merge [-h] --backend {fsdp,megatron} --local_dir LOCAL_DIR [--tie-word-embedding] [--is-value-model]
                                    [--target_dir TARGET_DIR] [--hf_upload_path HF_UPLOAD_PATH] [--private]
